...
export default function HeroWallet() {
    return (
        <div className="h-auto relative bg-white py-6 px-4 rounded-lg shadow-sm flex flex-col items-center justify-center space-y-4">
            <h1 className="text-4xl font-bold text-center text-black">Wallet Dashboard</h1>
            <h1 className="text-xl font-semibold opacity-85">Your Complete Web3 Portfolio, In One Place</h1>
            <p className="opacity-85 sm:w-3/4 lg:w-1/2 text-center">
